...
add wave -position 14 sim:/testTimingAndControl/intSigIf/deassertDACK
add wave -position 15 sim:/testTimingAndControl/DUT/ior
add wave -position 16 sim:/testTimingAndControl/DUT/iow
add wave -position 17 sim:/testTimingAndControl/DUT/memr
add wave -position 18 sim:/testTimingAndControl/DUT/memw
add wave -position 19 sim:/testTimingAndControl/cpuIf/IOR_N
add wave -position 20 sim:/testTimingAndControl/cpuIf/IOW_N
add wave -position 21 sim:/testTimingAndControl/cpuIf/MEMR_N
add wave -position 22 sim:/testTimingAndControl/cpuIf/MEMW_N
add wave -position 23 sim:/testTimingAndControl/cpuIf/READY
add wave -position 24 sim:/testTimingAndControl/intSigIf/intEOP
add wave -position 25 sim:/testTimingAndControl/cpuIf/CS_N
add wave -position 26 sim:/testTimingAndControl/intRegIf/modeReg
add wave -position 27 sim:/testTimingAndControl/intSigIf/updateCurrentWordCountReg
add wave -position 28 sim:/testTimingAndControl/intSigIf/updateCurrentAddressReg
add wave -position 29 sim:/testTimingAndControl/cpuIf/EOP_N
run -all
